...
SUPPLY_SNAPSHOT_RECOVERY_MESSAGE = (
    "Cached supply data is unavailable. Click the global Refresh button "
    "to reload it."
)
...
def _snapshot_recovery_option():
    return [
        {
            "label": SUPPLY_SNAPSHOT_RECOVERY_MESSAGE,
    ...
    try:
        if comparison_source == "ea":
            ...
            _, comparison_df = _get_historical_comparison_frame(
                ...
                builder=lambda: fetch_ea_export_flow_raw_data_for_upload(
                    ea_upload_value,
                    start_date=start_date,
                    end_date=end_date,
                ),
        ...
        _, comparison_df = _get_historical_comparison_frame(
            ...
            selection=selection,
            query_dependencies={},
            builder=lambda: fetch_woodmac_export_flow_raw_data_for_publications(
            ...
            [
                ...
                html.Div(
                    [
                        html.Label(
                            ...
                            htmlFor="balance-destination-aggregation-dropdown",
                            className="filter-group-header",
                        ),
                        dcc.Dropdown(
                ...
                html.Div(
                    [
                        html.Label(
                            ...
                            htmlFor="balance-country-dropdown",
                            className="filter-group-header",
                        ),
                        dcc.Dropdown(
                ...
                html.Div(
                    [
                        html.Label(
                            "Other Countries",
                            htmlFor="balance-other-country-mode",
                            className="filter-group-header",
                        ),
                        dcc.RadioItems(
...
@log_callback_timing("supply.source_load")
...
@log_callback_timing("supply.tables_render")
...
@log_callback_timing("supply.woodmac_comparison_render")
...
@log_callback_timing("supply.ea_comparison_render")
